...
set title 'Numerical solution of du/dt(t) = -2tu, u(0)=2' font ',20'
set xlabel 't'
set ylabel 'u(t)'
set terminal qt font 'CMU Serif, 12' enhanced
plot 'data/euler_test10_0.dat' with points ls 1 title '', \
'data/euler_test10_1.dat' with lines ls 1 title ''
